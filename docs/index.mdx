...
WebTeX is tool for technical and scientific writing. It builds on Markdown, which lets you do the basic formatting that you expect from any writing app. WebTeX extends Markdown by adding support for math expressions, citations, and cross-referencing.
...
Other than that, WebTeX follows the [CommonMark spec](https://commonmark.org/).
...
<Callout>
  If you don't want to use captions or automatic numbering, check out the
...
<Callout>
  Currently, WebTeX uses the [ACM citation style](https://www.acm.org/publications/authors/reference-formatting). We plan to support other styles in the future.
</Callout>
...
<Callout>
  There are a lot of HTML elements, take a look at [this list](https://developer.mozilla.org/en-US/docs/Web/HTML/Element#inline_text_semantics) for some useful ones.
</Callout>
